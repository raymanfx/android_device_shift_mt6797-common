...
struct Light : public ILight {
    Light(std::ofstream&& lcd_backlight, std::ofstream&& led_brightness,
  ...
  private:
    ...
    std::ofstream mLedBrightness;
    std::ofstream mLedFlashMode;
    std::ofstream mLedFlashPeriod;

    LightState mBacklightState;
